...
hoi_interaction_names = json.loads(
    open('/home/bit118/wangyuhan/Index_HOIP2A/HOI2A/data/HOI2A_verb_names.json', 'r').readlines()[0])['verb_names']
...
class HoiDetection(VisionDataset):
    ...
    def __getitem__(self, index):
        ...
        if 'train2014' in img_name:
            img_path = '/home/bit118/data/datasetDir/coco/coco/train2014/%s' % img_name
        elif 'val2014' in img_name:
            img_path = '/home/bit118/data/datasetDir/coco/coco/val2014/%s' % img_name
        else:
            img_path = '/home/bit118/data/datasetDir/XD-violence/train_image/%s' % img_name
...
def build(image_set, test_scale=-1):
    ...
    if image_set == 'train':
        annotation_file = './data/vcoco/vcoco_trainval_retag_hoitr_Add.odgt'
    else:
